...
def sqrtm(A, disp=..., blocksize=...): # -> NDArray[Any] | tuple[Any, Any | floating[Any] | float]:
    """
...
@_apply_over_batch(('A', 2))
def signm(A, disp=...): # -> Any | NDArray[float64] | tuple[Any | NDArray[float64], Any | floating[Any] | float | int]:
    """
