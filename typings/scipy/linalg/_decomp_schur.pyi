...
def schur(a, output=..., lwork=..., overwrite_a=..., sort=..., check_finite=...): # -> tuple[ndarray[_AnyShape, dtype[Any]] | NDArray[long] | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | NDArray[long] | NDArray[Any]] | tuple[ndarray[_AnyShape, dtype[Any]] | NDArray[long] | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | NDArray[long] | NDArray[Any], Literal[0]] | tuple[Any, Any] | tuple[Any, Any, Any]:
    """
