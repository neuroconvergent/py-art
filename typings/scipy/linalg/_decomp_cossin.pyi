...
__all__ = ['cossin']
def cossin(X, p=..., q=..., separate=..., swap_sign=..., compute_u=..., compute_vh=...): # -> tuple[tuple[Any, Any], Any, tuple[Any, Any]] | tuple[ndarray[tuple[()], dtype[Any]], _Array[tuple[int, int], float64], ndarray[tuple[()], dtype[Any]]]:
    """
