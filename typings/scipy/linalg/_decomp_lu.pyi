...
def lu_factor(a, overwrite_a=..., check_finite=...): # -> tuple[NDArray[Any], _Array1D[signedinteger[_32Bit]]] | tuple[Any, Any]:
    """
...
def lu(a, permute_l=..., overwrite_a=..., check_finite=..., p_indices=...): # -> tuple[ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]] | tuple[NDArray[signedinteger[_32Bit]] | NDArray[Any], ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]]] | tuple[ndarray[_AnyShape, dtype[Any]] | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | NDArray[Any]] | tuple[NDArray[Any], ndarray[_AnyShape, dtype[Any]] | NDArray[Any], ndarray[_AnyShape, dtype[Any]] | NDArray[Any]] | tuple[ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | NDArray[Any]] | tuple[NDArray[Any] | _Array1D[signedinteger[_32Bit]] | NDArray[signedinteger[_32Bit]], ndarray[_AnyShape, dtype[Any]] | NDArray[Any] | ndarray[Any, dtype[Any]], ndarray[Any, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | NDArray[Any]]:
    """
