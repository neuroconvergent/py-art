...
def eigvalsh_tridiagonal(d, e, select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64], ndarray[Any, dtype[float64]] | NDArray[float64]] | tuple[Any, Any]:
    """
...
@_apply_over_batch(('d', 1), ('e', 1))
def eigh_tridiagonal(d, e, eigvals_only=..., select=..., select_range=..., check_finite=..., tol=..., lapack_driver=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64], ndarray[Any, dtype[float64]] | NDArray[float64]] | tuple[Any, Any]:
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
