...
def compute_grad(J, f): # -> NDArray[Any] | ndarray[tuple[int, int], dtype[Any]]:
    """Compute gradient of the least-squares cost function."""
    ...

def compute_jac_scale(J, scale_inv_old=...): # -> tuple[NDArray[float64] | Any, NDArray[float64] | Any | NDArray[Any]]:
