...
def call_minpack(fun, x0, jac, ftol, xtol, gtol, max_nfev, x_scale, jac_method=...): # -> OptimizeResult:
    ...

def prepare_bounds(bounds, n): # -> tuple[ndarray[tuple[int], dtype[Any]] | NDArray[Any], ndarray[tuple[int], dtype[Any]] | NDArray[Any]]:
    ...

def check_tolerance(ftol, xtol, gtol, method): # -> tuple[Any | Literal[0], Any | Literal[0], Any | Literal[0]]:
    ...

def check_x_scale(x_scale, x0, method): # -> ndarray[tuple[int], dtype[Any]] | NDArray[Any] | float | int | str:
    ...
...
IMPLEMENTED_LOSSES = ...
def construct_loss_function(m, loss, f_scale): # -> Callable[..., Any | _Array[tuple[int, int], float64]] | None:
    ...
...
@_workers_wrapper
def least_squares(fun, x0, jac=..., bounds=..., method=..., ftol=..., xtol=..., gtol=..., x_scale=..., loss=..., f_scale=..., diff_step=..., tr_solver=..., tr_options=..., jac_sparsity=..., max_nfev=..., verbose=..., args=..., kwargs=..., callback=..., workers=...):
