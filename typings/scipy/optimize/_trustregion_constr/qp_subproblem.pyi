...
def box_sphere_intersections(z, d, lb, ub, trust_radius, entire_line=..., extra_info=...): # -> tuple[Any, Any, bool, dict[str, float | Any | int | bool], dict[str, int | Any | bool]] | tuple[Any, Any, bool]:
