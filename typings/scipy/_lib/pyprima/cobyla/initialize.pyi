...
'''
def initxfc(calcfc, iprint, maxfun, constr0, amat, bvec, ctol, f0, ftarget, rhobeg, x0, xhist, fhist, chist, conhist, maxhist): # -> tuple[_Array1D[Any], NDArray[float64], NDArray[float64], Any, Any | _Array[tuple[int, int], float64] | ndarray[_AnyShape, dtype[float64]], NDArray[float64], intp, Literal[3, 1, -2, -1, 0]]:
    '''
