...
def create_multimethod(*args, **kwargs): # -> Callable[..., _Wrapped[..., tuple[Dispatchable, ...], ..., Any]]:
    """
...
def generate_multimethod(argument_extractor: ArgumentExtractorType, argument_replacer: ArgumentReplacerType, domain: str, default: typing.Callable | None = ...): # -> _Wrapped[..., tuple[Dispatchable, ...], ..., Any]:
    """
    Generates a multimethod.
...
def all_of_type(arg_type): # -> Callable[..., _Wrapped[..., Any, ..., tuple[Dispatchable, ...]]]:
    """
...
def wrap_single_convertor(convert_single): # -> _Wrapped[..., Any, ..., _NotImplementedType | list[Any]]:
    """
...
def wrap_single_convertor_instance(convert_single): # -> _Wrapped[..., Any, ..., _NotImplementedType | list[Any]]:
    """
    Wraps a ``__ua_convert__`` defined for a single element to all elements.
    If any of them return ``NotImplemented``, the operation is assumed to be
    undefined.
