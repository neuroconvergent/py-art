...
_cache = ...
def build_system(interpolation): # -> tuple[None, None, None] | tuple[_Array[tuple[int, int], float64], _Array1D[float64], tuple[Any, Any]]:
    """
...
class Models:
    ...
    def update_interpolation(self, k_new, x_new, fun_val, cub_val, ceq_val): # -> Incomplete:
        """
