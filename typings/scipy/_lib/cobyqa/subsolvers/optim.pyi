...
def qr_tangential_byrd_omojokun(aub, aeq, free_xl, free_xu, free_ub): # -> tuple[intp, NDArray[Any] | tuple[NDArray[Any], NDArray[Any]] | tuple[Any, Any] | Any]:
    ...

def qr_normal_byrd_omojokun(aub, free_xl, free_xu, free_slack, free_ub): # -> tuple[intp, NDArray[Any] | tuple[NDArray[Any], NDArray[Any]] | tuple[Any, Any] | Any]:
    ...
