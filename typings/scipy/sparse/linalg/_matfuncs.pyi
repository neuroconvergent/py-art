...
def expm(A): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[Any, dtype[Any]] | csc_array | Any | _NotImplementedType:
    """
...
def matrix_power(A, power): # -> csc_array | csc_matrix | csr_array | csr_matrix | coo_array | coo_matrix | dia_array | Any | dia_matrix:
    """
