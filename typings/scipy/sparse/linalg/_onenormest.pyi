...
"""
__all__ = ['onenormest']
def onenormest(A, t=..., itmax=..., compute_v=..., compute_w=...): # -> tuple[Any | _Array1D[Any] | Literal[0], ...] | tuple[Any | Literal[0], ...] | tuple[Any | Literal[0], _Array1D[Any]] | tuple[Any | Literal[0]] | Any | Literal[0]:
    """
...
def elementary_vector(n, i): # -> _Array1D[Any]:
    ...
