...
_ARPACK_LOCK = ...
def eigs(A, k=..., M=..., sigma=..., which=..., v0=..., ncv=..., maxiter=..., tol=..., return_eigenvectors=..., Minv=..., OPinv=..., OPpart=...): # -> NDArray[Any] | NDArray[float64] | tuple[NDArray[Any] | NDArray[float64] | Any, NDArray[float64] | NDArray[Any], NDArray[float64] | NDArray[Any]] | tuple[NDArray[Any] | NDArray[float64] | Any, NDArray[float64] | NDArray[Any]] | tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any] | tuple[NDArray[Any] | Any, NDArray[Any] | Any] | tuple[Any, Any]:
    """
...
def eigsh(A, k=..., M=..., sigma=..., which=..., v0=..., ncv=..., maxiter=..., tol=..., return_eigenvectors=..., Minv=..., OPinv=..., mode=...): # -> tuple[Any | ndarray[_AnyShape, dtype[float64]], Any | NDArray[float64] | NDArray[Any]] | ndarray[_AnyShape, dtype[float64]] | tuple[Any, Any]:
    """
