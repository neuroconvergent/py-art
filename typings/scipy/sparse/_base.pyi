...
class _spbase(SparseABC):
    ...
    def __matmul__(self, other): # -> _NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int, int], dtype[Any]] | NDArray[Any] | matrix[_2D, dtype[Any]]:
        ...
    ...
    def todense(self, order=..., out=...): # -> NDArray[Any] | matrix[_2D, dtype[Any]]:
        """
    ...
    def sum(self, axis=..., dtype=..., out=...): # -> Any | NDArray[Any] | matrix[_2D, dtype[Any]]:
        """
    ...
    def mean(self, axis=..., dtype=..., out=...): # -> ndarray[_2D, dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | Any | matrix[_2D, dtype[Any]]:
        """
