...
@docfiller
def spline_filter1d(input, order=..., axis=..., output=..., mode=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
@docfiller
def spline_filter(input, order=..., output=..., mode=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
@docfiller
def geometric_transform(input, mapping, output_shape=..., output=..., order=..., mode=..., cval=..., prefilter=..., extra_arguments=..., extra_keywords=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
@docfiller
def map_coordinates(input, coordinates, output=..., order=..., mode=..., cval=..., prefilter=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
@docfiller
def affine_transform(input, matrix, offset=..., output_shape=..., output=..., order=..., mode=..., cval=..., prefilter=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
...
@docfiller
def shift(input, shift, output=..., order=..., mode=..., cval=..., prefilter=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
    Shift an array.
...
@docfiller
def zoom(input, zoom, output=..., order=..., mode=..., cval=..., prefilter=..., *, grid_mode=...): # -> Array | _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
    Zoom an array.
...
@docfiller
def rotate(input, angle, axes=..., reshape=..., output=..., order=..., mode=..., cval=..., prefilter=...): # -> _Array1D[float64] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    """
    Rotate an array.
