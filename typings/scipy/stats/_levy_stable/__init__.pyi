...
class levy_stable_gen(rv_continuous):
    ...
    @inherit_docstring_from(rv_continuous)
    def pdf(self, x, *args, **kwds): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]] | Any | None:
        ...
    
    @inherit_docstring_from(rv_continuous)
    def cdf(self, x, *args, **kwds): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]] | Any | None:
        ...
