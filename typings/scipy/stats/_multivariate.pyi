...
class wishart_gen(multi_rv_generic):
    ...
    def mean(self, df, scale): # -> ndarray[_AnyShape, dtype[complex128]] | Any:
...
class wishart_frozen(multi_rv_frozen):
    ...
    def mean(self): # -> ndarray[_AnyShape, dtype[complex128]] | Any:
        ...
...
class special_ortho_group_gen(multi_rv_generic):
    ...
    def rvs(self, dim, size=..., random_state=...): # -> ndarray[_AnyShape, dtype[Any]]:
        """Draw random samples from SO(N).
