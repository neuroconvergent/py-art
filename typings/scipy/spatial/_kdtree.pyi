...
class KDTree(cKDTree):
    ...
    def query(self, x, k=..., eps=..., p=..., distance_upper_bound=..., workers=...): # -> tuple[Any, signedinteger[_NBitIntP] | Any]:
...
def distance_matrix(x, y, p=..., threshold=...): # -> Any | _Array[tuple[int, int], Any]:
