...
EPS = ...
def estimate_fun_jac(fun, x, y, p, f0=...): # -> tuple[_Array[tuple[int, int, int], float64], _Array[tuple[int, int, int], float64] | None]:
...
def estimate_bc_jac(bc, ya, yb, p, bc0=...): # -> tuple[_Array[tuple[int, int], float64], _Array[tuple[int, int], float64], _Array[tuple[int, int], float64] | None]:
