...
def prepare_events(events): # -> tuple[tuple[Callable[..., object]] | Any, _Array1D[float64], _Array1D[float64]]:
...
def handle_events(sol, events, active_events, event_count, max_events, t_old, t): # -> tuple[Any, ndarray[_AnyShape, dtype[Any]], bool]:
