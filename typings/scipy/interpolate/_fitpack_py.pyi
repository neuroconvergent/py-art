...
def splev(x, tck, der=..., ext=...): # -> list[list[list[Any] | Any] | Any]:
    """
...
def splint(a, b, tck, full_output=...): # -> NDArray[Any] | list[list[list[Any] | tuple[Any, Any] | Any] | tuple[Any, Any] | Any] | tuple[Any, Any]:
    """
...
def splder(tck, n=...): # -> BSpline | tuple[Any, Any | Incomplete, Any]:
    """
