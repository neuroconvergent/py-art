...
class RegularGridInterpolator:
    ...
    **Interpolate and extrapolate a 2D dataset**
    ...
    def __call__(self, xi, method=..., *, nu=...): # -> NDArray[Any] | ndarray[_AnyShape, dtype[Any]] | Any:
        """
...
def interpn(points, values, xi, method=..., bounds_error=..., fill_value=...): # -> NDArray[Any] | ndarray[_AnyShape, dtype[Any]] | Any:
    """
