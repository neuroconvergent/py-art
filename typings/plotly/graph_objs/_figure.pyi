...
class Figure(BaseFigure):
    ...
    def add_funnel(self, alignmentgroup=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., marker=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatefallback=..., texttemplatesrc=..., uid=..., uirevision=..., visible=..., width=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., zorder=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def add_parcats(self, arrangement=..., bundlecolors=..., counts=..., countssrc=..., dimensions=..., dimensiondefaults=..., domain=..., hoverinfo=..., hoveron=..., hovertemplate=..., hovertemplatefallback=..., labelfont=..., legendgrouptitle=..., legendwidth=..., line=..., meta=..., metasrc=..., name=..., sortpaths=..., stream=..., tickfont=..., uid=..., uirevision=..., visible=..., row=..., col=..., **kwargs) -> Figure:
        """
    ...
    def add_waterfall(self, alignmentgroup=..., base=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., decreasing=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatefallback=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., measure=..., measuresrc=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., offsetsrc=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatefallback=..., texttemplatesrc=..., totals=..., uid=..., uirevision=..., visible=..., width=..., widthsrc=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., zorder=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
